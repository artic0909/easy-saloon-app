...
class AdminOpenBookingsPage extends StatefulWidget {
  const AdminOpenBookingsPage({super.key});

  @override
  State<AdminOpenBookingsPage> createState() => _AdminOpenBookingsPageState();
}

class _AdminOpenBookingsPageState extends State<AdminOpenBookingsPage> {
    ...
    try {
      ...
      if (response.data['status'] == 'success') {
        ...
        setState(() {
          ...
          // Filter out on_the_way and started for the open tab
    ...
    return Center(
      child: ListView(
        ...
        children: [
          ...
          SizedBox(height: 8.h),
          Text(
            "There are currently no new open bookings to manage.",
            textAlign: TextAlign.center,
            style: TextStyle(color: Colors.white38, fontSize: 12.sp),
          ),
        ],
