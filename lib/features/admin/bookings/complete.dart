...
class AdminCompleteBookingsPage extends StatefulWidget {
  const AdminCompleteBookingsPage({super.key});

  @override
  State<AdminCompleteBookingsPage> createState() => _AdminCompleteBookingsPageState();
}

class _AdminCompleteBookingsPageState extends State<AdminCompleteBookingsPage> {
  ...
  Future<void> _fetchBookings() async {
    ...
    try {
      final response = await _apiService.dio.get('/admin/bookings', queryParameters: {
      ...
      Get.snackbar("Error", "Failed to load complete bookings",
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: "Search complete bookings...",
